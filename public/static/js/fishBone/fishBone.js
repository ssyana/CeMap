        ...
        $(data).each(function(index) {
            ...
            if(itemclass=='top'){
                $.each(this, function(name, value) {
                    if (name == 'timeLeft') {
                        var li = $("<li class='line-first' style='color:#333;font-family:Microsoft Yahei;'>" + value + "</li>")
            ...
            //封装其他属性
            $.each(this, function(name, value) {
                if (name != 'files' && name != 'timeLeft' && value=="space") {
                    var li = $("<li class='spaceLine' > </li>").css("border-left","1px solid "+color);
                    li.appendTo(ul);
                }
            });
          //封装审理时间和案号
