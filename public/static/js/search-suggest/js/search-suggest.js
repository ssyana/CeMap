                ...
                ddiv.find('.list').each(function() {
                    $(this).unbind('mouseover').mouseover(function() {
                        ...
                        if (opts.multiWord) { //空格分隔的多关键字处理
                            ...
                            parent.attr("data-id",$(this).find('div:first').attr("rel_id").substring(3));
                            parent.attr("data-others",$(this).find('div:first').attr("data-others"));
                        }
                        $(this).parents(".search-suggest").hide();
                        //ddiv.empty().hide();
                        parent.focus();
                        opts.changeCall();
                    });
            ...
            var options = $.extend({
                ...
                json: {         //注意数据格式
                    data: [{
                        'id': '0',
                        'word': 'lzw.me',
                        'description': 'http://sumii.cn'
                    }],
                    defaults: 'http://sumii.cn'
                },
